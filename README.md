...
- [SwapTitan](https://swaptitan.net) - Non-custodial cross-chain swap infrastructure for autonomous agents, with an MCP server, x402 pay-per-call (USDC on Base), and agent-payable RPC across Ethereum, Base, Solana, BNB and Polygon.
